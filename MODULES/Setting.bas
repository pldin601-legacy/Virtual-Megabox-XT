...
Sub GlbLoadSettings()
 ...
 GlbWndScroll = Val(GetIniRecord("GLOBAL_WINDOW_SCROLL=", LowPath(App.Path) + "vmbxt.ini"))
 GlbWndFluent = Val(GetIniRecord("GLOBAL_WINDOW_FLUENT=", LowPath(App.Path) + "vmbxt.ini"))
 GlbWndColor = GetIniRecord("GLOBAL_WINDOW_COLOR=", LowPath(App.Path) + "vmbxt.ini")
