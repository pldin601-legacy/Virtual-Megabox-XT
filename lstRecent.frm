...
Quest = MsgBox("Are you sure want to DELETE recent playlist file?", vbExclamation + vbYesNo, "Delete Recent Playlist")

If Quest = 6 Then
  Kill LowPath(GlbRecentDir) + "r_" + lstLists.List(lstLists.ListIndex) + ".mxt"
  If Err Then MsgBox "Deleting was not completed!", vbCritical, "Error!"
End If
